...
public class EmployeesInfo {
    ...
    public static void main(String[] args) {
        ...
        // NOTE: NetBeans does not allow the ₱ symbol. It may display as ?
        ...
        HourlyEmployee hEmp2 =
                new HourlyEmployee(102, new Name("Neil", "Villarito"),
                        38.0f, 180.0);
        ...
        PieceWorkerEmployee pEmp1 =
                new PieceWorkerEmployee(201, new Name("Bob", "Job"));

        pEmp1.setTotalPieceFinished(250);
        pEmp1.setRatePerPiece(15.0);

        PieceWorkerEmployee pEmp2 =
                new PieceWorkerEmployee(202, new Name("Sofia", "the", "First"),
                        120, 20.0);
        ...
        CommissionEmployee cEmp2 =
                new CommissionEmployee(302, new Name("Phoenix", "Wright"),
                        120000.0);
        ...
        BasePlusCommissionEmployee bEmp1 =
                new BasePlusCommissionEmployee(401,
                        new Name("Super", "Man"));
        ...
        BasePlusCommissionEmployee bEmp2 =
                new BasePlusCommissionEmployee(402,
                        new Name("Joe", "Marata"),
                        45000.0, 10000.0);
