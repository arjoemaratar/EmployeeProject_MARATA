...
//NOTE:Netbeans does not allow the ₱ it does a ?
        System.out.println("--- Hourly Employee Test ---");
        
 
        HourlyEmployee hEmp1 = new HourlyEmployee(101, new Name("Daniel","Sanding"));
        hEmp1.setTotalHoursWorked(45.0f);
        hEmp1.setRatePerHour(200.0);


        HourlyEmployee hEmp2 = new HourlyEmployee(102, "Neil Villarito", 38.0f, 180.0);
        ...
        PieceWorkerEmployee pEmp2 = new PieceWorkerEmployee(202, "Sofia the first", 120, 20.0);
        ...
        CommissionEmployee cEmp1 = new CommissionEmployee(301, "Vanoss Gaming");
        cEmp1.setTotalSale(75000.0);


        CommissionEmployee cEmp2 = new CommissionEmployee(302, "Phoenix Wright", 120000.0);
        ...
        BasePlusCommissionEmployee bEmp1 = new BasePlusCommissionEmployee();
        bEmp1.setEmpID(401);
        ...
        BasePlusCommissionEmployee bEmp2 = new BasePlusCommissionEmployee(402, "Joe Marata", 45000.0, 10000.0);
